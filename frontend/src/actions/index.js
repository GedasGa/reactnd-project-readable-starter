...
export const addComment = (id, body, author, parentId) => (dispatch) =>
  addCommentAPI(id, body, author, parentId)
...
export const updateComment = (commentId, title, body) => (dispatch) =>
  updateCommentAPI(commentId, title, body)
